...
const Route = (logger, router) => {
  ...
  router.get('/property/:property_id',
    Authentication.userToken,
    PropertyController.findOne);

  router.get('/properties',
    Authentication.userToken,
    PropertyMiddleware.findByType,
    PropertyController.findByType);

  router.patch('/property/:property_id',
    Authentication.userToken,
    PropertyMiddleware.update,
    PropertyController.update);

  router.patch('/property/:property_id/sold',
    Authentication.userToken,
    PropertyMiddleware.markSold,
    PropertyController.markSold);
